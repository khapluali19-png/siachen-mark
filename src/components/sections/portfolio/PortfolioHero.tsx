    ...
    >
      ...
      <Container className="relative max-w-4xl">
        ...
        <p className="text-lg text-[var(--color-on-navy)] max-w-2xl leading-relaxed mb-8 opacity-90">
          A selection of client engagements across performance marketing, branding, web development, and SEO — showing the work we did and the business problems we solved.
        </p>
        ...
        <div className="mt-10 flex flex-wrap gap-2" aria-label="Industries served">
          {[
            "Healthcare", "Hospitality", "E-commerce", "Real Estate",
            "Logistics", "Technology", "Education", "Food & Beverage",
          ].map((ind) => (
            <span
              key={ind}
              className="px-3 py-1 rounded-full border border-white/15 bg-white/5 text-[var(--color-on-navy)] text-xs font-medium"
            >
              {ind}
            </span>
          ))}
